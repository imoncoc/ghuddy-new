...
const Banner = () => {
  return (
    <div className="w-full custom-banner-background pt-[66px]
    xl:pt-[66px] ">
      <div className="custom-banner-background h-[322px] xl:h-[293px] ">
        <div className="xl:max-w-[1100px] md:max-w-[765px] xl:px-[0px] max-w-[375px] px-[18px] md:px-[0px] h-[300px]  mx-auto">
          <h2 className="text-[24px] xl:text-[32px] font-medium text-txt-secondary text-start md:text-center pt-[44px] pb-[16px] tracking-[0.96px]">
            Bangladesh, Dhaka
          </h2>
            ...
            <div className="flex">
              ...
              <div className="bg-bg-primary rounded-full">
                <button className="flex items-center justify-center gap-1 w-[116px] h-[40px] bottom-[1px] ">
                  ...
                  <span className="font-normal mt-1 text-btn-third">
                    Hotel
                  </span>
                </button>
              </div>
          ...
          {/* TODO: Start */}
          {/* <div className="max-w-screen-2xl mx-auto bg-bg-semiblack p-6 rounded-lg shadow-xl">
          ...
          {/* TODO: Destop */}
          <div className="hidden flex-row  my-[32px]  xl:flex items-center justify-between bg-bg-primary text-base16 rounded-full pt-[2px] pr-[2px] pb-[2px] pl-[2px] text-txt-primary_light">
            {/* <div className="pr-[32px] pl-[60px] py-[14px]">
                Where are We going?
              </div> */}
            <div className="bg-bg-primary h-[44px] flex items-center justify-center px-[32px] w-[244px] py-[14px] rounded-l-full">
              Where are We going?
            </div>
            <div className="border-r-[1px] border-btn-border_light h-[35px]"></div>
            <div className="bg-bg-primary h-[44px] flex items-center justify-center px-[32px]  py-[14px] rounded-l-full">Check In</div>
            <div className="border-r-[1px] h-[35px] border-btn-border_light"></div>
            <div className="bg-bg-primary h-[44px] flex items-center justify-center px-[32px]  py-[14px] rounded-l-full">Check Out</div>
            <div className="border-r-[1px] h-[35px] border-btn-border_light"></div>
            <div className="bg-bg-primary h-[44px] flex items-center justify-center px-[32px]  py-[14px] rounded-l-full">Guests</div>
            <div className="flex flex-row items-center justify-center text-btn-secondary h-[48px] w-[48px] border-[1px] border-btn-secondary rounded-full py-[14px] pr-[6.5px] pl-[5.5px]">
              Go!
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="12"
          ...
          {/* TODO: Tab */}
          <div className="hidden flex-row  my-[32px]  md:flex xl:hidden items-center justify-between bg-bg-primary text-base16 rounded-full pt-[2px] pr-[2px] pb-[2px] pl-[2px] text-txt-primary_light">
            {/* <div className="pr-[32px] pl-[60px] py-[14px]">
                Where are We going?
              </div> */}
            <div className="bg-bg-primary h-[44px] flex items-center justify-center px-[24px] w-[244px] py-[14px] rounded-l-full">
              Where are We going?
            </div>
            <div className="border-r-[1px] border-btn-border_light h-[35px]"></div>
            <div className="bg-bg-primary h-[44px] flex items-center justify-center px-[32px]  py-[14px] rounded-l-full">Check In</div>
          ...
          <div className="md:hidden">
            <div className=" flex flex-row items-center justify-between bg-bg-primary rounded-full text-base14 mb-[18px] px-[2px] py-[2px] text-txt-primary_light font-n">
              <div className="flex items-center justify-center  h-[44px] w-[283px] text-base14 font-normal">
                Where are We going?
              </div>
              <div className="flex flex-row items-center justify-center h-[44px] w-[44px] border-[1px] text-btn-secondary border-btn-secondary rounded-full">
                Go!
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="12"
            ...
            <div className="flex flex-row  justify-between  text-base14 ">
              <div className="flex items-center justify-center rounded-full
               bg-bg-primary p-[2px] group">
                <div className="h-[44px] w-[105px] flex items-center justify-center rounded-l-full gap-0 group-hover:border-btn-secondary">
                  Check In
                </div>
                <div className="border-r-[1px] border-btn-border_lighter h-[24px] px-[4px]group-hover:border-bg-primary"></div>
                <div className="h-[44px] w-[105px] flex items-center justify-center rounded-l-full gap-0 group-hover:border-btn-secondary">
                  Check Out
                </div>
              </div>

              <div className="h-[44px] w-[105px] flex items-center justify-center rounded-full gap-0 bg-bg-primary group-hover:border-btn-secondary">
                Guests
              </div>
            </div>
          </div>
